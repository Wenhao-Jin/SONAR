...
def call_main():
    ...
    parser.add_option('--outfile_feature_table', dest='PPI_feature_table_out', help='Specify the path and name of output feature table generated by our program.', default='./PPI_feature_table.xls', metavar='FILE')

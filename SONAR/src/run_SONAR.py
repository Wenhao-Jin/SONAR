...
parser.add_argument('--outfile_feature_table', dest='PPI_feature_table_out', help='Specify the path and name of output feature table generated by our program.', default='./PPI_feature_table.xls', metavar='FILE')
...
parser.add_argument('-F', '--feature_table', dest='PPI_feature_table', help='Specify the feature table used in classification given by user.')
